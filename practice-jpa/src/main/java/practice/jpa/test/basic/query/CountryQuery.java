package practice.jpa.test.basic.query;

import static practice.jpa.test.basic.entity.country.QCity.city;
import static practice.jpa.test.basic.entity.country.QCountry.country;
